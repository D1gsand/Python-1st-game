...
bg_sounds = pygame.mixer.Sound('sounds\The_epic_bg_sound_2.mp3')
#bg_sounds.play()
...
label = pygame.font.Font('fonts\RobotoMono-Medium.ttf', 40)
lose_label = label.render('You lose!', False, (193, 196, 199))
restart_label = label.render('Play', False, (115, 132, 148))
restart_label_rect = restart_label.get_rect(topleft=(200, 220))

bullets_left = 5
bullet = pygame.image.load('images/1bullet.png').convert_alpha()
bullets = []
